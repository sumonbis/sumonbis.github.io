---
title: Quantifying Uncertainty of DNN Hyperparameter Optimization using a First Order Type
summary: We provided aid to the deep learning programmers to quantify uncertainty in the model hyperparameters and help them to make informed decision while initializing hyperparameters. We have leveraged a first order type Uncertain<T> to represent the uncertainty in the random hyperparameters and choose the best value by performing statistical tests on the distribution.
tags:
- Uncertainty
...
- icon: github
  icon_pack: fab
  name: GitHub
  url: https://github.com/sumonbis/Uncertainty-in-DNN/
url_code: ""
url_pdf: ""
url_slides: ""
url_video: ""
